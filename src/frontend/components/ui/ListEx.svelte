...
<div class="group/list flex flex-col mb-1 select-none">
	<!-- GROUP HEADER -->
	<div 
		class="flex items-center gap-2 p-2 mb-1 bg-pulse-white/1 border border-pulse-white/2 hover:bg-white/5 transition-colors rounded-md group"
		on:click={toggle}
	>
