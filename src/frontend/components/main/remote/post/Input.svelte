...
<div class="flex gap-3">
	...
	<div class="relative flex-grow flex">
		...
		<textarea
			...
			class="custom-scroll overflow-y-auto flex-1 resize-none rounded-xl bg-pulse-white/5 border border-zinc-700 px-3 py-2 text-sm outline-none focus:border-zinc-500"
